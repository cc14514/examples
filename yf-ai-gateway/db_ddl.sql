...
-- token for service controller  
insert into users (id, name, type, password, ticket, ticket_created_at, scopes, created_at) values (2, 'AI_product', 1, '', 'eT5QWkLhQmp6lO4NWxAc', now(), 'Product', now());

-- token for config agent
...
-- insert demo product for k8s test
insert into user_products (user_id, product_id, created_at, updated_at) values (2, 1, now(), now());
